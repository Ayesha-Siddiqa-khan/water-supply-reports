# Graph Report - water suppy report  (2026-07-16)

## Corpus Check
- 29 files · ~90,219 words
...
### Community 0 - "BytesIO"
Cohesion: 0.09
Nodes (55): bill_list_export_rows(), _bracket_rich_text(), build_connection_summary(), _card_rows_to_df(), commercial_daily_income_export_rows(), daily_staff_receive_export_response(), daily_staff_receive_export_tables(), download_card() (+47 more)
...
- **Why does `_get_season_bill_ids()` connect `app.py` to `get_db`?**
