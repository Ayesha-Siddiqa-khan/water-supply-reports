...
### Community 0 - "BytesIO"
Cohesion: 0.05
Nodes (85): bill_income_category_export_rows(), _bracket_rich_text(), build_connection_summary(), _calc_col_widths(), _calc_daily_detail_col_widths(), _calc_daily_summary_col_widths(), _card_rows_to_df(), commercial_daily_income_export_rows() (+77 more)
...
### Community 2 - "build_consumer_sector_remaining_report"
Cohesion: 0.06
...
Cohesion: 0.10
Nodes (43): build_bill_key(), build_commercial_daily_income_rows(), build_commercial_mask(), build_commercial_month_wise_summary(), build_commercial_rows(), build_daily_rows(), build_income_category_summary(), build_monthly_rows() (+35 more)
...
### Community 6 - "consumer_report"
Cohesion: 0.10
Nodes (30): ajax_error(), ajax_ok(), allowed_file(), arrear_calculator(), bill_list(), _clear_consumer_summary_cache(), consumer_report(), consumer_sector_remaining_report() (+22 more)

### Community 7 - "app.py"
Cohesion: 0.09
Nodes (21): apply_manual_zone_overrides(), bill_list_export_rows(), export_advanced_bills(), export_sectors_summary(), export_staff_summary(), export_zones_summary(), file_column_matcher(), file_merger() (+13 more)
...
### Community 9 - "get_db"
Cohesion: 0.19
Nodes (23): bill_list_sector_seasonly_export_rows(), bill_list_staff_export_rows(), bill_list_zone_export_rows(), build_unpaid_amount_summary(), clear_bill_list_data(), export_six_month_pitch(), get_bill_list_context(), get_db() (+15 more)

### Community 10 - "build_daily_staff_receive_report"
Cohesion: 0.12
...
Cohesion: 0.17
Nodes (13): backfill_bill_arrears(), _bill_list_summary_from_rows(), is_large_pdf_text(), merge_sector_list_rows(), merge_sector_rows(), normalise_sector(), parse_number(), Normalise a sector name for grouping: trim, lowercase, collapse spaces. (+5 more)
...
Cohesion: 0.24
Nodes (10): _build_dnc_register_report(), _dnc_classification(), _dnc_money(), _dnc_pair(), _dnc_rate_and_classification(), _dnc_report_rows(), _dnc_split_sector_locality(), _dnc_sum_rows() (+2 more)
...
### Community 21 - "index"
Cohesion: 0.38
Nodes (7): build_dashboard_results(), index(), _load_dashboard_results(), _load_results_cache(), Build the All Received Bills dashboard once and reuse it for the rendered page a, remove_pdf_column(), _save_results_cache()
