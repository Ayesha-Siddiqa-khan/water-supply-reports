...
def export_consumer_report(fmt_type: str):
    ...
    if fmt_type == "pdf":
        ...
        table_data.append([
            ...
            Paragraph("", cell_center_style),
            Paragraph(str(gt["closed"]), ParagraphStyle("GrandNum", parent=cell_center_style, fontName="Helvetica-Bold", fontSize=9, textColor=PDF_GRAND_FG)),
            Paragraph(str(gt["active"]), ParagraphStyle("GrandNum2", parent=cell_center_style, fontName="Helvetica-Bold", fontSize=9, textColor=PDF_GRAND_FG)),
            Paragraph(str(gt["total"]), ParagraphStyle("GrandNum3", parent=cell_center_style, fontName="Helvetica-Bold", fontSize=9, textColor=PDF_GRAND_FG)),
        ])
